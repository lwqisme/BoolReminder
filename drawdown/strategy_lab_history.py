...
def _config_summary(payload: Mapping[str, object]) -> dict[str, object]:
    ...
    return {
        ...
        "buy_strategy": _strategy_selector(payload.get("buy_strategies")) or payload.get("buy_strategy") or payload.get("default_buy_strategy"),
        "sell_strategy": _strategy_selector(payload.get("sell_strategies")) or payload.get("sell_strategy") or payload.get("default_sell_strategy"),
