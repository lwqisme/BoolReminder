...
class StrategyLabFrontendTest(unittest.TestCase):
    ...
    def test_parameter_lab_cell_replays_detail_inside_parameter_lab(self):
        ...
        self.assertIn("line: { color: '#1167d8', width: 2.3 }", html)
        self.assertIn("tradeTrace('buy', '买入', '#38bdf8', 'circle', '#eaf7ff')", html)
        self.assertIn("tradeTrace('sell', '卖出', '#64748b', 'diamond', '#f8fafc')", html)
        self.assertIn("paper_bgcolor: 'rgba(255,255,255,0)'", html)
        self.assertIn("gridcolor: 'rgba(174,185,200,0.30)'", html)
